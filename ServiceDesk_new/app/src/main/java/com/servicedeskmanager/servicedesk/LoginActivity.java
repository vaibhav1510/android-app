...
import com.servicedeskmanager.servicedesk.util.SDResponse;
...
//        });
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            RestFulPost restFulPost = new RestFulPost(this, this.getApplication(), "Please Wait", "Login");
    ...
    public void onResfulResponse(String result, String responseFor) {
        ...
        if (responseFor.equals("Login")) {
           ...
           //String error = "";
            // LoginResponseData data = gson.fromJson(gson.toJson(response.getData()), LoginResponseData.class);
            if(response==null) {
               // error = "Network issue, please try again !!";
                Log.i("responce", "null");

                loginmsg.setText("Network issue, please try again !!");
                loginmsg.setVisibility(View.VISIBLE);

            } else if (response != null) {
                    if (response.getToken() != null) {
                        Log.i("responce", "not null");
