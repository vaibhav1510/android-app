...
public class Add_incident extends AppCompatActivity implements RestFulResult,
    ...
    {
        selectAsset=new AssetListModel();

        selectAsset.setDisplay_id("ITEM0002");
        selectAsset.setItem_type("Firewall");
        selectAsset.setInventory_id("10");
        selectAsset.setCriticality("4-Low");
    }
